...
def create_export_buttons(data: Dict[str, Any], filename_base: str, include_formats: List[str] = ['json', 'csv']):
    """
...
def _export_txt(data: Dict[str, Any], filename_base: str, timestamp: str):
    ...
    lines = [
        f"5D Framework Simulation Report",
...
def display_export_section(
    ...
    include_formats: List[str] = ['json', 'csv', 'txt']
):
    """
