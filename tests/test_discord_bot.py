...
async def test_embed_contains_imp_score():
    ...
    has_imp_content = (
        'imp' in embed_text or 'imp' in embed_title or
        'autonomie' in embed_text or 'motivation' in embed_text or
        'resilienz' in embed_text or 'partizipation' in embed_text
    )
