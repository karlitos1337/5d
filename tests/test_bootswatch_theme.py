...
def test_link_id_present():
    html = read_html()
    assert 'id="bootswatch-css"' in html, (
...
def test_version_validation():
    ...
    assert "safeFallbackVersion" in html, (
...
def test_crossorigin_attribute():
    ...
    assert "'anonymous'" in html or '"anonymous"' in html, 'crossOrigin="anonymous" value not found'  # noqa: E501
