...
def test_theme_config_centralized():
    ...
    assert "THEME_CONFIG.defaultTheme" in html or "defaultTheme:" in html, "defaultTheme not in THEME_CONFIG"
    assert "THEME_CONFIG.allowedThemes" in html or "allowedThemes:" in html, "allowedThemes not in THEME_CONFIG"
...
def test_sanitization_present():
    ...
    assert "[^a-z0-9\\-]" in html or "[^a-z0-9-]" in html, "Theme name sanitization regex pattern not found"
...
def test_version_validation():
    ...
    assert "semverPattern" in html or "semver" in html.lower(), "semver validation pattern not found"
