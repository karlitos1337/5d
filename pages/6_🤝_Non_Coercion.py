...
def main():
    ...
    with col_left:
        ...
        **Modell:** Agenten wählen zwischen Kooperation und Defektion
        ...
        if 'history' in st.session_state:
            ...
            with result_col1:
                st.metric("Final Cooperators", final_cooperators, 
                         delta=final_cooperators - history['cooperators'][0])
            
            with result_col2:
                st.metric("Final Defectors", final_defectors,
    ...
    with tab2:
        ...
        **In unserer Simulation:**
        ...
        st.latex(r"\text{Equilibrium} = \begin{cases} \text{Cooperate} & \text{if } C > Penalty \\ \text{Defect} & \text{if } Penalty > C \end{cases}")
    ...
    with col_c:
        st.markdown("[zwi_streamlit.py](zwi_streamlit.py) | [Nobel Prize](https://www.nobelprize.org/prizes/economic-sciences/2009/ostrom/facts/)")
