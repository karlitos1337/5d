...
def run_simulation(n, steps, zwang, freiheit, peers, lehrer, vielfalt, seed=42):
    ...
    hist = {
        "step": [],
        "A_mean": [], "IM_mean": [], "R_mean": [], "SP_mean": [], "Au_mean": [],
        "A_std": [], "IM_std": [], "R_std": [], "SP_std": [], "Au_std": [],
        "active_count": [],
        "dropout_events": []
    }
...
if show_dropouts and history['dropout_events']:
    ...
    fig_dropout.add_trace(go.Scatter(
        x=dropout_steps,
        y=dropout_counts,
        mode='markers+lines',
