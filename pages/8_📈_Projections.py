...
def load_regional_adoption_projections():
    ...
    regions = [
        # Nordeuropa - High readiness (existing alternative education infrastructure)
        {
            ...
            "key_drivers": ["Folk High Schools legacy", "High WGI governance", "Low dropout rates"],  # noqa: E501
            "scenario": "Optimistic",
        },
        {
            "name": "Netherlands",
...
def create_regional_adoption_map(regions_data):
    ...
    for region in regions_data:
        ...
        <div style="font-family: Arial; width: 240px;">
            ...
            <p style="margin: 4px 0;"><strong>Projected Adoption 2030:</strong> {adoption_2030 * 100:.0f}%</p>  # noqa: E501
            <p style="margin: 4px 0;"><strong>Readiness Score:</strong> {readiness_score:.2f}</p>
            <p style="margin: 4px 0;"><strong>Scenario:</strong> <span style="color: {scenario_color};">{scenario}</span></p>  # noqa: E501
...
def main():
    ...
    st.markdown(
        ...
        **Readiness Score** combines governance quality, existing alternative education infrastructure,  # noqa: E501
        and mental health/dropout drivers.
        
        📊 **Legend:** Green = Optimistic (≥35%), Orange = Moderate (25-34%), Blue = Conservative (<25%)  # noqa: E501
        """
    )
    ...
    st.caption(
        ...
        "WGI governance indicators. Optimistic scenario assumes policy support; Conservative assumes status quo."  # noqa: E501
    )
    ...
    with col_left:
        ...
        **Logistic Growth Model (S-Curve):**
        ...
        # Optimistic
        optimistic = logistic_curve(years, max_adoption * 1.2, steepness * 1.5, inflection_year - 5)  # noqa: E501
    ...
    with tab1:
        ...
        **Quelle:** Verhulst, P. F. (1838). *Notice sur la loi que la population suit dans son accroissement*  # noqa: E501
        """
        )
    ...
    with tab2:
        ...
        **Quelle:** Heckman, J. J. (2006). *Skill Formation and the Economics of Investing in Disadvantaged Children*  # noqa: E501
    ...
    with tab3:
        ...
        **Literatur:**
        ...
        - Bass, F. M. (1969). *A New Product Growth Model for Consumer Durables*. Management Science, 15(5): 215-227.  # noqa: E501
        - Mahajan, V., Muller, E., & Bass, F. M. (1990). *New Product Diffusion Models in Marketing*. Journal of Marketing, 54(1): 1-26.  # noqa: E501
        """
        )
    ...
    with col_c:
        st.markdown(
            "[Rogers 2003](https://books.google.com/books?id=v1ii4QsB7jIC) | [Heckman 2006](https://doi.org/10.1126/science.1128898)"  # noqa: E501
        )
