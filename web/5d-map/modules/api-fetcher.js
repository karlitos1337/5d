...
async function fetchWithCache(key, fetcher) {
  ...
  try {
    ...
    // Re-read cache immediately before writing to avoid race conditions
    // with parallel concurrent fetches modifying the same cache
...
export async function fetchAllData() {
  ...
  // Launch all independent network requests concurrently
  const [
    schoolsData,
    countries,
    validation,
