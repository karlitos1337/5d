...
async function init() {
  ...
  // Debounce the expensive map update to improve performance during slider drag
  const updateMapForYear = debounce((year) => {
  ...
  yearSlider?.addEventListener('input', (e) => {
    ...
    // Call the debounced function for map updates
