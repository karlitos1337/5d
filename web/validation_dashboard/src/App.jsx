...
const App = () => {
  ...
  useEffect(() => {
    // ⚡ Bolt: Cache DOM elements once outside the scroll handler to prevent repeated queries
    // Do not filter(Boolean) to maintain index alignment with the sections array
    ...
    // ⚡ Bolt: Pass { passive: true } to improve scrolling performance
