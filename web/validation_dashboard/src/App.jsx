...
const App = () => {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'}`}>
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-0 focus:left-0 focus:z-[60] focus:p-4 focus:bg-white focus:text-blue-600 focus:font-bold focus:rounded-br-lg focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
