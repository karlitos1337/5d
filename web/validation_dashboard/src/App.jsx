...
const App = () => {
  ...
  useEffect(() => {
    // ⚡ Bolt: Cache DOM elements once outside the scroll handler instead of querying them continuously
    ...
    // ⚡ Bolt: Use passive event listener to prevent main-thread blocking during scroll
