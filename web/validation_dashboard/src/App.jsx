...
const App = () => {
  ...
  useEffect(() => {
        ...
        window.requestAnimationFrame(() => {
          ...
          for (let i = sections.length - 1; i >= 0; i--) {
            ...
            if (section && scrollPosition >= section.offsetTop) {
              // ⚡ Bolt: Throttled scroll event handler to prevent main thread blocking
              // during rapid scrolling. We use requestAnimationFrame with a ticking lock.
    ...
    // ⚡ Bolt: Added { passive: true } to prevent scrolling jank by telling the browser
    // that preventDefault() won't be called.
