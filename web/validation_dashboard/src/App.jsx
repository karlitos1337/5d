...
const App = () => {
  ...
  useEffect(() => {
    document.querySelectorAll('[data-ref]').forEach(el => {
      ...
      // Ensure btn can be positioned correctly if attached to a wrapper
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'}`}>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-4 focus:bg-white focus:text-black focus-visible:ring-2 focus-visible:outline-none"
      >
