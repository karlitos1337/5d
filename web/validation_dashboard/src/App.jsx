...
const App = () => {
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt Optimization: Throttle scroll events using requestAnimationFrame to avoid main-thread blocking
    let ticking = false;
    ...
    // ⚡ Bolt Optimization: Use passive event listener for better scroll performance
        ...
        <section id="framework" className={`py-16 ${darkMode ? 'bg-gray-800' : 'bg-gray-50'}`}>
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                {/* ⚡ Bolt Optimization: Add loading="lazy" to defer below-the-fold image load */}
                <img
