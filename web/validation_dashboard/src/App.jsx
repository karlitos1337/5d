...
const App = () => {
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt Optimization: Use local variable for scroll throttling instead of useRef
    let ticking = false;

    const handleScroll = () => {
      // ⚡ Bolt Optimization: Throttle scroll events with requestAnimationFrame to prevent main thread blocking
      if (!ticking) {
        ...
        <section id="framework" className={`py-16 ${darkMode ? 'bg-gray-800' : 'bg-gray-50'}`}>
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                {/* ⚡ Bolt Optimization: Lazy load below-the-fold images to improve initial load time */}
                <img
