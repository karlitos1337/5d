          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className={`p-2 rounded-lg transition-colors duration-200 ${darkMode ? 'focus-visible:ring-offset-gray-900' : 'focus-visible:ring-offset-white'} focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
              ...
              <button
                ...
                className={`md:hidden p-2 rounded-lg transition-colors duration-200 ${darkMode ? 'focus-visible:ring-offset-gray-900' : 'focus-visible:ring-offset-white'} focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
                  darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-100'
                }`}
              >
