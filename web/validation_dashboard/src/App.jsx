...
const App = () => {
  ...
  useEffect(() => {
    ...
    // ⚡ Bolt: Added requestAnimationFrame throttling and { passive: true } to the scroll event listener.
    // This prevents main-thread blocking and layout thrashing during scroll events, improving scroll performance.
