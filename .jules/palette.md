...
## 2026-06-03 - AI-Generated Alt Text Improvement
**Learning:** AI generators often create excessively verbose "prompt-style" alt text (e.g., describing layout, color patterns, and chart components in painful detail) instead of summarizing the semantic meaning or core data. These over-detailed descriptions are overwhelming for screen reader users and fail to convey the key takeaway efficiently.
**Action:** Always replace AI-generated descriptive alt text with concise summaries that convey the actual meaning or data points the image represents in the context of the content (e.g., summarizing the chart correlation rather than describing axes and dots).
