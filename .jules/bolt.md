...
## 2026-05-27 - Cache DOM references and Throttle Scroll Handlers
**Learning:** Continuously querying the DOM with document.getElementById inside a scroll event handler and lacking requestAnimationFrame throttling causes unnecessary overhead and layout thrashing.
**Action:** Map and cache DOM elements outside the scroll handler, use requestAnimationFrame for throttling, and use { passive: true } to optimize scroll tracking in continuous event loops.
