...
QUESTIONS = {
    "Autonomy": [
        "Ich fühle mich frei, meine Arbeit so zu gestalten, wie es mir entspricht.",
        "Meine Entscheidungen treffe ich basierend auf meinen eigenen Überzeugungen.",
        "Ich habe Kontrolle über die Art und Weise, wie ich meine Aufgaben erledige.",
        "Ich fühle mich nicht unter Druck gesetzt, Dinge zu tun, die ich nicht will.",
        "Ich kann meine Ziele selbstbestimmt wählen und verfolgen.",
    ],
    ...
    "Authenticity": [
        "Ich verhalte mich so, wie es meiner wahren Persönlichkeit entspricht.",
        "Ich muss mich nicht verstellen, um von anderen akzeptiert zu werden.",
        "Meine Handlungen stehen im Einklang mit meinen Werten.",
        "Ich fühle mich wohl dabei, meine Meinung offen zu äußern.",
        "Ich bin mir meiner Stärken und Schwächen bewusst und stehe dazu.",
    ],
}
