...
QUESTIONS = {
    "Autonomy": [
        "Ich treffe Entscheidungen über mein Lernen und Arbeiten selbstständig.",
        "Ich fühle mich frei, meine eigenen Wege zur Lösung von Aufgaben zu wählen.",
        "Ich erlebe mich als Urheber meines eigenen Handelns.",
        "Ich kann meine Aufgaben so gestalten, wie es für mich am besten ist.",
    ...
    "Authenticity": [
        "Ich handle in Übereinstimmung mit meinen Werten und Überzeugungen.",
        "Ich fühle mich wohl dabei, ich selbst zu sein.",
        "Ich muss mich nicht verstellen, um akzeptiert zu werden.",
        "Meine Handlungen spiegeln meine wahre Persönlichkeit wider.",
        "Ich stehe zu meinen Entscheidungen, auch wenn sie unpopulär sind.",
    ],
}
