...
QUESTIONS = {
    ...
    "Authenticity": [
        "Ich handle im Einklang mit meinen tiefsten Überzeugungen.",
        "Ich fühle mich frei, meine ehrliche Meinung zu äußern.",
        "Meine Handlungen spiegeln wider, wer ich wirklich bin.",
        "Ich verstelle mich nicht, um anderen zu gefallen.",
        "Ich übernehme Verantwortung für meine eigenen Entscheidungen.",
    ],
}
