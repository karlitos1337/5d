...
QUESTIONS = {
    "Autonomy": [
        "Ich treffe meine Entscheidungen selbstbestimmt und unabhängig.",
        "Ich fühle mich frei, meine Arbeit nach meinen eigenen Vorstellungen zu gestalten.",
        "Ich handele in Übereinstimmung mit meinen eigenen Werten, nicht aufgrund von Druck.",
        "Ich übernehme Verantwortung für meine Entscheidungen und deren Konsequenzen.",
        "Ich fühle mich nicht gezwungen, Dinge zu tun, die ich nicht will.",
    ],
    ...
    "Authenticity": [
        "Ich verhalte mich so, wie es meinem wahren Wesen entspricht.",
        ...
        "Mein Handeln stimmt mit meinen inneren Gefühlen überein.",
    ],
}
