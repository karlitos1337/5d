...
class ResearchScraper:
    ...
    def fetch_wgi_data(self, countries=None):
        ...
        Indicators: VA.EST (Voice & Accountability), RL.EST (Rule of Law), GE.EST (Government Effectiveness)
        ...
        for indicator_code, indicator_name in indicators.items():
            print(f"  ⚖️ WGI: Fetching {indicator_name} ({indicator_code})...")

            # Batch countries to avoid URL too long or API limits
            batch_size = 10
    ...
    def scrape_all(self):
        ...
        print("\n⚖️ Fetching World Bank Governance Indicators (WGI)...")
