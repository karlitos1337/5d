...
class ResearchScraper:
    ...
    def fetch_world_bank_wgi_data(self, countries=None):
        ...
        wgi_data = {}
        # VA.EST is Voice and Accountability: Estimate
        indicators = {"VA.EST": "Voice & Accountability"}

        print("  🏛️  World Bank WGI: Fetching Voice & Accountability...")

        for indicator_code, indicator_name in indicators.items():
            # Chunk countries in groups of 10
            chunk_size = 10
            for i in range(0, len(countries), chunk_size):
                ...
                for attempt in range(self.max_retries):
                    try:
                        ...
                        # WGI uses source=3 usually, but standard API might work with indicator code
                        url = (
                        ...
                        print(f"    ❌ Error fetching WGI chunk: {e}")
                        break
    ...
    def scrape_all(self):
        ...
        # World Bank WGI Data (Autonomy)
        print("\n🏛️  Fetching World Bank WGI Data (Autonomy)...")
