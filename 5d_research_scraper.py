...
class ResearchScraper:
    ...
    def fetch_world_bank_wgi_data(self, countries=None):
        """
        Fetch Voice & Accountability (WGI) data from World Bank.
        Mapped to 5D Dimension: Autonomy.
        ...
        indicator_code = "VA.EST"  # Voice and Accountability: Estimate
        indicator_name = "Voice & Accountability (Autonomy)"

        wgi_data = {}

        print(f"  🏛 World Bank WGI: Fetching {indicator_name}...")

        # Batch processing (10 countries per request)
        batch_size = 10
    ...
    def scrape_all(self):
        ...
        # World Bank WGI Data
        print("\n🏛 Fetching World Bank WGI Data (Voice & Accountability)...")
        wgi_data = self.fetch_world_bank_wgi_data()
        all_research["wgi_governance"] = {
            "data": wgi_data,
            "timestamp": datetime.now().isoformat(),
