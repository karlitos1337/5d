...
class ResearchScraper:
    ...
    def fetch_world_bank_wgi_data(self, countries=None):
        """
        Fetch Governance indicators (Voice & Accountability) from World Bank.
        ...
        # WGI indicator for Voice & Accountability
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                # World Bank API endpoint
                # Batching requests 10 at a time if list is long, but here we just do first 10 for safety/demo as in education
                ...
                if isinstance(data, list) and len(data) > 1:
                    for entry in data[1]:
                        ...
                        if country_code and value is not None:
                            ...
                            # Keep most recent data
                            # For WGI, we only have one indicator here, but structure allows expansion
    ...
    def scrape_all(self):
        ...
        # World Bank WGI Data (Voice & Accountability)
