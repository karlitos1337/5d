...
```mermaid
graph TD
    FMHYB64[FMHYB64<br/>10.000+ Resources]
    FPB[Free Programming Books<br/>8.000+ Books]
    AC[Awesome Cheatsheets<br/>30+ Single Files]
    OSSU[OSSU Curriculum]
    IB[IB Resources]
    
    FMHYB64 -->|Educational Section| OSSU
    FMHYB64 -->|Programming Section| FPB
    FPB -->|Cheat Sheets Link| AC
    
    OSSU -->|Books| FPB
    OSSU -->|Quick Ref| AC
    
    IB -->|Computer Science HL| FPB
    IB -->|Exam Prep| AC
    
    style FMHYB64 fill:#f96,stroke:#333,stroke-width:4px
    style FPB fill:#9cf,stroke:#333,stroke-width:2px
