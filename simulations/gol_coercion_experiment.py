...
def run_experiment(n_trials: int = 100, size: int = 20, steps: int = 200, 
                   density: float = 0.3, output: str = "gol_experiment_results.json") -> dict:
    """
    ...
    """
    print(f"🧪 Starting Game of Life Coercion Experiment")
    ...
    hypothesis = "supported" if (diversity_p < 0.05 and np.mean(non_coercive_diversity) > np.mean(coercive_diversity) and
                                  longevity_p < 0.05 and np.mean(non_coercive_longevity) > np.mean(coercive_longevity)) else "rejected"
    ...
    print(f"\n📈 STATISTICAL SUMMARY:")
    print(f"   Diversity (Shannon Entropy):")
    print(f"     Coercive:     {statistics['diversity']['coercive_mean']:.4f} ± {statistics['diversity']['coercive_std']:.4f}")
    print(f"     Non-Coercive: {statistics['diversity']['non_coercive_mean']:.4f} ± {statistics['diversity']['non_coercive_std']:.4f}")
    ...
    print(f"     Coercive:     {statistics['longevity']['coercive_mean']:.2f} ± {statistics['longevity']['coercive_std']:.2f}")
    print(f"     Non-Coercive: {statistics['longevity']['non_coercive_mean']:.2f} ± {statistics['longevity']['non_coercive_std']:.2f}")
    ...
    print(f"   Expected: non-coercive > coercive (diversity H > 0.8, longer longevity)")
