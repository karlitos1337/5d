...
from five_d_net import FiveDNet, BaselineNet, add_noise, fgsm_attack, count_parameters
...
def run_experiment(config: Dict) -> Dict:
    ...
    print(f"   5D-Net:   {avg_drop_5d:.2f}%")
    print(f"   Baseline: {avg_drop_baseline:.2f}%")
    print(f"   ✅ Expected: 5D < Baseline (5D more robust)")
    ...
    print(f"H₁: 5D-Net < Baseline in Accuracy Drop")
