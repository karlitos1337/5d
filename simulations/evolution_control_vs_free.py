    ...
    def evolve(self, environment: Dict, generations: int, verbose: bool = True):
        ...
        for gen in range(generations):
            ...
            if verbose and (gen % 20 == 0 or gen == generations - 1):
                print(f"  Gen {gen:3d}: Diversity={diversity:.3f}, "
...
def plot_results(controlled: Population, free: Population, save_path: str = None):
    ...
    ax = axes[0, 0]
    ax.plot(generations, controlled.history['diversity'], 
            label='Controlled (Designer)', color='red', linewidth=2)
    ax.plot(generations, free.history['diversity'], 
            label='Free (Natural)', color='green', linewidth=2)
    ...
    # Plot 2: Mean Fitness
    ax = axes[0, 1]
    ax.plot(generations, controlled.history['mean_fitness'], 
            label='Controlled', color='red', linewidth=2)
    ax.plot(generations, free.history['mean_fitness'], 
            label='Free', color='green', linewidth=2)
    ax.set_xlabel('Generation')
    ...
    # Plot 3: Max Fitness
    ax = axes[1, 0]
    ax.plot(generations, controlled.history['max_fitness'], 
            label='Controlled', color='red', linewidth=2)
    ax.plot(generations, free.history['max_fitness'], 
            label='Free', color='green', linewidth=2)
    ax.set_xlabel('Generation')
    ...
    ax = axes[1, 1]
    ax.plot(generations, controlled.history['survival_rate'], 
            label='Controlled', color='red', linewidth=2)
    ax.plot(generations, free.history['survival_rate'], 
            label='Free', color='green', linewidth=2)
    ax.set_xlabel('Generation')
